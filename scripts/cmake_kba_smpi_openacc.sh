...
\
  -DCMAKE_C_FLAGS:STRING="-O3 -DNM_VALUE=$NM_VALUE $ALG_OPTIONS -DUSE_ACC -DUSE_ACCELDIR -DUSE_KBA -I$MPI_INCLUDE_DIR -acc -Minfo=accel -Msafeptr -ta=tesla:pinned,cc70,cc60" \
